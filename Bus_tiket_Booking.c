...
{
	int choice;
	printf("\n\t Simple Bus Ticket Booking System in Daffodil International University\n");
	printf("\t||====================================================================||\n");
	printf("\t||             1- To edit price of ticket (only Authority):           ||\n");
	printf("\t||             2- To view reserved tickets(only Authority):           ||\n");
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Daffodil Express\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 08-012-2022\n");
        printf("\t                                              Time      : 08:00pm\n");
        printf("\t                                              Hall      : 02\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Daffodil Express\n\n");
	printf("\t\t\tpress 2 for Daffodil Sun-Flower Express\n\n");
	printf("\t\t\tpress 3 for Daffodil VIP Express \n");
	printf("\n\n\t\t\tEnter the Bus Name Press flowing above : ");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name :Daffodil Sun-Flower Express\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 08-012-2022\n");
        printf("\t                                              Time      : 09:00pm\n");
        printf("\t                                              Hall      : 03\n");
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Daffodil VIP Express \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 08-012-2022\n");
        printf("\t                                              Time      : 10:00pm\n");
        printf("\t                                              Hall      : 04\n");
